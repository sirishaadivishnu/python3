# A program for tallying the number of sales during the day, calculating the total amount of money made, and keeping track of the names of customers
...
for transaction in daily_transactions_split:
  ...
  for data_point in transaction:
   transactionclean.append(data_point.strip(" "))
  transactions_clean.append(transactionclean)
